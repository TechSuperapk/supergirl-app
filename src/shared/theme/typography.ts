...
export const FontFamily = { regular:'DMSans-Regular', medium:'DMSans-Medium', bold:'DMSans-Bold', semiBold:'DMSans-SemiBold', light:'DMSans-Regular', extraLight:'DMSans-Regular', italic:'DMSans-Italic', boldItalic:'DMSans-Italic' } as const;
...
export const TextStyles = {
  ...
  headingLarge:  { fontFamily:'DMSansFlex',     fontSize:24, lineHeight:32, fontWeight:'680' } as TextStyle,
  headingMedium: { fontFamily:'DMSansFlex',     fontSize:20, lineHeight:27, fontWeight:'680' } as TextStyle,
  headingSmall:  { fontFamily:'DMSansFlex',     fontSize:17, lineHeight:25, fontWeight:'680' } as TextStyle,
